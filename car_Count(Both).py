...
while True:
    ...
    cv2.rectangle(mask,(242,184),(559,378),(255,255,255),-1)
    masked_frame = cv2.bitwise_and(frame, frame, mask=mask)

    cv2.polylines(frame, [np.array([[242,184],[559,184],[559,378],[242,379]], np.int32)], isClosed=True, color=(0, 255, 0), thickness=2)
    ...
    for r in result:
        ...
        for box in boxes:
            ...
            if (CurrentClass in ['car', 'bicycle', 'motorbike', 'bus']) and conf > 0.3:
    ...
    cv2.putText(frame,f'Count  : {len(totalcount)}',(25,20),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
